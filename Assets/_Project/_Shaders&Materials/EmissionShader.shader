...
Shader "EmissionShader"
{
	Properties
	{
		...
		_BaseColor("BaseColor", Color) = (0.9320754,0.2514845,0.2514845,0)
	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float fresnelNode13 = ( 0.06 + 1.0 * pow( 1.0 - fresnelNdotV13, 5.0 ) );
				

				float3 BaseColor = _BaseColor.rgb;
				float3 Normal = float3(0, 0, 1);
				float3 Emission = ( ( _BaseColor * 9.3 ) * fresnelNode13 ).rgb;
				float3 Specular = 0.5;
				float Metallic = 0;
...
/*ASEBEGIN
Version=19603
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;14;-240,-304;Inherit;True;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;12;-928,-48;Inherit;True;Constant;_Float0;Float 0;0;0;Create;True;0;0;0;False;0;False;9.3;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;11;-656,-176;Inherit;True;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.FresnelNode;13;-496,144;Inherit;True;Standard;WorldNormal;ViewDir;False;False;5;0;FLOAT3;0,0,1;False;4;FLOAT3;0,0,0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;5;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;15;-804.8579,286.7407;Inherit;False;Constant;_Float1;Float 1;0;0;Create;True;0;0;0;False;0;False;0.06;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;10;-864,-640;Inherit;False;Property;_BaseColor;BaseColor;0;0;Create;True;0;0;0;False;0;False;0.9320754,0.2514845,0.2514845,0;0.9320754,0.2514845,0.2514845,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
ASEEND*/
//CHKSM=652D8709E5E93199AB9B1D3F3D6E5EC288C9AE44