	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float4 color10 = IsGammaSpace() ? float4(0.3056603,0.3056603,0.3056603,0) : float4(0.07607294,0.07607294,0.07607294,0);
				
				float3 temp_cast_1 = (0.44).xxx;
...
/*ASEBEGIN
Version=19603
Node;AmplifyShaderEditor.RangedFloatNode;11;-272.8,331.6994;Inherit;False;Constant;_Float0;Float 0;0;0;Create;True;0;0;0;False;0;False;0.44;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;10;-416,-112;Inherit;False;Constant;_Color0;Color 0;0;0;Create;True;0;0;0;False;0;False;0.3056603,0.3056603,0.3056603,0;0,0,0,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
